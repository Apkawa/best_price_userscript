...
> [!NOTE]
> Добавлено зеркало на [gitverse](https://gitverse.ru/Apkawa/best_price_userscript/), в некоторых случаях новые изменения могут заливаться на gitverse из за белых списков. Основное репо все равно github
...
|-----------------------------|------------|--------------------|------------------------------------------------------------------------------------------------------------------------------------|
| https://ozon.ru/            | 2021-10-21 | 2026-06-08         | Ссылки в каталоге открываются только через среднюю кнопку мыши из за решения проблемы с путаницей ссылок в каталоге при сортировке |
| https://lenta.com/          | 2022-10-24 | 2026-06-04        |                                                                                                                                    |
