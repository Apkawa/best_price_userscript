...
> [!NOTE]
> Добавлено зеркало на [gitverse](https://gitverse.ru/Apkawa/best_price_userscript/), в некоторых случаях новые изменения могут заливаться на gitverse из за белых списков.
